! function(a) {
    ...
    var c = function() {
        function c(c, e) {
            ...
            i.set(), a.setAttribute("muted"), a.setAttribute("autoplay"), a.setAttribute("loop"), a.setAttribute("playsinline"), j.removeAttribute("data-wf-ignore"), this.injectStyle(c), this.videoWrapper.appendChild(j), this.video = j, this.video.onplaying = function() {
