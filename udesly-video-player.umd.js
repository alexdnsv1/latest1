! function(a) {
    ...
    var c = function() {
        function c(c, e) {
            ...
            i.set(), j.setAttribute("muted"), j.setAttribute("autoplay"), j.setAttribute("loop"), j.setAttribute("playsinline"), j.removeAttribute("data-wf-ignore"), this.injectStyle(c), this.videoWrapper.appendChild(j), this.video = j, this.video.onplaying = function() {
